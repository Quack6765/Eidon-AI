...
const ASSISTANT_BUBBLE_BASE =
  "max-w-full rounded-2xl border border-white/8 bg-white/[0.03] px-2.5 py-2 md:px-4 md:py-3 text-[var(--text)] shadow-[0_2px_10px_rgba(0,0,0,0.22)]";
const ASSISTANT_BUBBLE = `w-fit ${ASSISTANT_BUBBLE_BASE}`;
