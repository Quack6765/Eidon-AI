...
const runtimeSettingsSchema = z.object({
  ...
  providerPresetId: z.enum(["ollama_cloud", "glm_coding_plan", "openai_official", "openrouter", "opencode_go", "deepseek", "xiaomi_mimo", "anthropic_official", "opencode_go_anthropic"]).nullable().default(null),
...
const PROVIDER_PROFILE_COLUMNS = `
  id, name, api_base_url, api_key_encrypted, model, api_mode, service_tier,
