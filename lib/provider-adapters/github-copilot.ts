...
export const githubCopilotConnectionFlows = {
  ...
  get: getMobileGithubOauthFlowForUser,
  cancel: cancelMobileGithubOauthFlow
};
...
export async function discoverGithubCopilotModels(settings: import("@/lib/types").ProviderProfileWithApiKey) {
